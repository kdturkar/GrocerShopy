...
const EditProductScreen = (props) => {
    ...
    const [imageFile,setImageFile] = useState((productDetail.product.imagePath &&  url_image + `/${productDetail.product.imageName}` )|| AddProduct)
    ...
    const onEditProduct = ()=>{
        const body ={
            product : {
                ...
                price,
                status : "ACTIVE",
                imagePath: productDetail.product.imagePath
            },
            category,
            stock : {
                id : productDetail.product.id,
