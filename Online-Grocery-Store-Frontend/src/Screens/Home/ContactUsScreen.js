                    ...
                    <div className="col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div className="row" Style="padding: 5px;">
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                                <strong className="fs-5">Krunal todkar</strong><br/>
                                <label className="fs-7">Store Manager</label><br/>
                                <label className="fs-7">krunal.todkar@grocers.com</label>
                            </div>
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                        ...
                        <div className="row" Style="padding: 5px;">
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                                <strong className="fs-5">Sushant Mane</strong><br/>
                                <label className="fs-7">Store Manager</label><br/>
                                <label className="fs-7">sushant.mane@grocers.com</label>
                            </div>
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
